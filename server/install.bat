...
cd ..
xcopy node_modules\audiojs\audiojs\*.js common_lib\js\
xcopy node_modules\audiojs\audiojs\*.swf common_lib\js\
xcopy node_modules\audiojs\audiojs\*.as common_lib\js\
